...
export function registerVerificationTools(
  ...
  server.registerTool(
    'get_verification_token',
    {
      ...
      outputSchema: z.object({
        ...
        token: z
          .string()
          .describe('Generated by Google. Place it, then verify.'),
        placement: z.string(),
      }),
    },
    ({ site_url, method }) =>
      run(async () => {
        ...
        // Marked: the token is a string Google generated, and the placement
        ...
        return untrustedTextResult(
            ...
            placementInstructions(site, chosen, token),
          {
            ...
            method: chosen,
            token,
            placement: placementInstructions(site, chosen, token),
          }
        );
      })
  );
  ...
  server.registerTool(
    'unverify_site',
    {
      ...
      // No untrusted marker: the property this server was given and the fact
        ...
        return guarded(
          ...
          async () => {
            ...
            return structuredResult({
              site: property,
              unverified: true,
              note: 'Regaining ownership means placing the token again.',
            });
          }
        );
      })
