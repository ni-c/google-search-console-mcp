...
const site = 'https://google-search-console-mcp.ni-c.de';
const description =
...
export default defineConfig({
  ...
  head: [
    ...
    ['meta', { property: 'og:title', content: 'google-search-console-mcp' }],
  ...
  themeConfig: {
    siteTitle: 'google-search-console-mcp',
      ...
      '/guide/': [
        {
          text: 'Introduction',
          items: [
            { text: 'What is google-search-console-mcp?', link: '/guide/' },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/ni-c/google-search-console-mcp' },
      {
        icon: {
    ...
    editLink: {
      pattern: 'https://github.com/ni-c/google-search-console-mcp/edit/main/docs/:path',
